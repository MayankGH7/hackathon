...
const FinancialOverview = ({ income, expenses, savings, balance }) => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4 mb-6">
      <div className="bg-white rounded-xl shadow-sm p-3 sm:p-4 flex flex-col">
        ...
        <div className="text-base sm:text-lg font-bold text-gray-800">${income.toLocaleString()}</div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-3 sm:p-4 flex flex-col">
        ...
        <div className="text-base sm:text-lg font-bold text-gray-800">${expenses.toLocaleString()}</div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-3 sm:p-4 flex flex-col">
        ...
        <div className="text-base sm:text-lg font-bold text-gray-800">${savings.toLocaleString()}</div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-3 sm:p-4 flex flex-col">
        ...
        <div className="text-base sm:text-lg font-bold text-gray-800">${(balance + savings).toLocaleString()}</div>
